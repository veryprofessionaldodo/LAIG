...
MySceneGraph.prototype.updatePlayAnimations = function(v)  {
    if(this.playAnimations === false){
        this.restartAnimation = true;
    }
    this.playAnimations = v;
}
/**
    Puts the flag to restart the animations to false
*/
MySceneGraph.prototype.updateRestartAnimations = function() {
    this.restartAnimation = false;
}
 ...
 */
 MySceneGraph.prototype.parseLSXFile = function(rootElement) {
    ...
    // <INITIALS>
    var index;
    if ((index = nodeNames.indexOf("INITIALS")) == -1) //if initials doesn't exist
        return "tag <INITIALS> missing";
    else {
        if (index != INITIALS_INDEX)  //if initials is out od order
 ...
 */
 MySceneGraph.prototype.parseInitials = function(initialsNode) {
    ...
    // Initial transforms.      IMPORTANT FOR LATER
 ...
 */
 MySceneGraph.prototype.displayScene = function(deltaTime) {
    ...
    this.updateRestartAnimations(); //puts the flag to restart animations to false
}
...
MySceneGraph.prototype.recursiveDisplay = function(deltaTime, nodeName, matrix, textureID, materialID) {
    if(nodeName != null){
        ...
        this.newMaterial = this.materials[materialID];
        //updates the texture
